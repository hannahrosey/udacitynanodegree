#Goal: create a multi-class classiciation model to quickly line items in school budgets by category
...
str(edat)
  # Total = cost
  # The following categories are manually added and should be predicted:
      #Function
      #Object_Type
      #Operating Status
      #Position Type
